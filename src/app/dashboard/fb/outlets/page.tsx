...
const items = [{"title": "Outlet Setup", "description": "ตั้งชื่อ outlet เวลาเปิดปิด และ mapping กับ folio", "keys": ["SUPABASE_SERVICE_ROLE_KEY"], "href": "https://supabase.com/dashboard"}];

export default function FBOutletsPage() {
  return (
    <div className="container max-w-6xl py-8 animate-fade-in">
      <TopBar title="F&B Outlets" description="หน้าเตรียมจัดการร้านอาหาร บาร์ คาเฟ่ และ room service outlet" />
