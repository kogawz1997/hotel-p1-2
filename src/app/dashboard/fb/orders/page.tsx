...
const items = [{"title": "Order Queue", "description": "เตรียมสถานะ new / preparing / served / cancelled และ charge to room", "keys": ["SUPABASE_SERVICE_ROLE_KEY"], "href": "https://supabase.com/dashboard"}];

export default function FBOrdersPage() {
  return (
    <div className="container max-w-6xl py-8 animate-fade-in">
      <TopBar title="F&B Orders" description="หน้าเตรียมรับออเดอร์ ร้านอาหาร บาร์ และ room service" />
