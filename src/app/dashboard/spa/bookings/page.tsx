...
const items = [{"title": "Booking Calendar", "description": "เตรียม time slot, therapist availability และ charge to room", "keys": ["SUPABASE_SERVICE_ROLE_KEY"], "href": "https://supabase.com/dashboard"}];

export default function SpaBookingsPage() {
  return (
    <div className="container max-w-6xl py-8 animate-fade-in">
      <TopBar title="Spa Bookings" description="หน้าเตรียมจองสปาและ wellness schedule" />
