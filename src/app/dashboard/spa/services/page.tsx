...
const items = [{"title": "Service Catalog", "description": "เตรียม service, duration, room, therapist requirement และ commission", "keys": ["SUPABASE_SERVICE_ROLE_KEY"], "href": "https://supabase.com/dashboard"}];

export default function SpaServicesPage() {
  return (
    <div className="container max-w-6xl py-8 animate-fade-in">
      <TopBar title="Spa Services" description="หน้าเตรียมบริการสปา ราคา ระยะเวลา และแพ็กเกจ" />
