...
const items = [{"title": "Therapist Roster", "description": "เตรียม roster, skill, leave, commission tracking", "keys": ["SUPABASE_SERVICE_ROLE_KEY"], "href": "https://supabase.com/dashboard"}];

export default function SpaTherapistsPage() {
  return (
    <div className="container max-w-6xl py-8 animate-fade-in">
      <TopBar title="Therapists" description="หน้าเตรียมจัดการพนักงานสปา ตารางงาน และ commission" />
