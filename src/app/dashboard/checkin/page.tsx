...
const items = [{"title": "QR Verification", "description": "เตรียม endpoint ตรวจ reservation code และ token สำหรับหน้า portal ของแขก", "keys": ["NEXT_PUBLIC_APP_URL", "SUPABASE_SERVICE_ROLE_KEY"], "href": "https://supabase.com/dashboard"}, {"title": "ID / Passport Upload", "description": "เตรียม flow สำหรับแนบเอกสารและยืนยันตัวตนก่อนเข้าพัก", "keys": ["SUPABASE_STORAGE_BUCKET"], "href": "https://supabase.com/docs/guides/storage"}];

export default function CheckinPage() {
  return (
    <div className="container max-w-6xl py-8 animate-fade-in">
      <TopBar title="QR Check-in" description="หน้าเตรียมสแกน QR ตรวจ booking และเริ่ม self check-in" />
