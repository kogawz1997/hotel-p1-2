...
const items = [{"title": "Maintenance Board", "description": "เตรียมตารางงาน pending / in progress / completed และ priority สำหรับทีมช่าง", "keys": ["SUPABASE_SERVICE_ROLE_KEY"], "href": "https://supabase.com/dashboard"}, {"title": "Notification Provider", "description": "เสียบ LINE/Email เพื่อแจ้งเตือนทีมซ่อมเมื่อมีงานด่วน", "keys": ["LINE_CHANNEL_ACCESS_TOKEN", "SENDGRID_API_KEY"], "href": "https://developers.line.biz/console/"}];

export default function MaintenancePage() {
  return (
    <div className="container max-w-6xl py-8 animate-fade-in">
      <TopBar title="Maintenance Requests" description="หน้าเตรียมรับแจ้งซ่อม อุปกรณ์ ห้อง และสถานะงานซ่อมบำรุง" />
